 ...
 *
 */
public class ChildLockView extends LinearLayout implements KeyBoardDelegate {
	...
	public ChildLockView(Context context) {
		...
		this.addView(
				LayoutInflater.from(context).inflate(R.layout.childlock,
		...
		contentLayout = (LinearLayout) findViewById(R.id.childLockLayout);
	...
	public ChildLockView(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
	}

	public ChildLockView(Context context, AttributeSet attrs, int defStyle) {
