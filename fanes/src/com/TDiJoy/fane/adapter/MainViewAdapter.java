...
public class MainViewAdapter implements ListAdapter,CellActionDelegate{
	private List<GameInfo> list;
	private LayoutLogic layoutLogic;
	private Context context;
	public MainViewAdapter(Context context, List<GameInfo> list, LayoutLogic layoutLogic) {
		this.list = list;
...
//		GameInfo gameInfo = getItem(position - 1);
